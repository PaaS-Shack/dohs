...
module.exports = {
    ...
    actions: {
        ...
        get: {
            permissions: ['dohs.get'],
            needEntity: true,
            permissions: []
        },

        update: {
            permissions: ['dohs.update'],
            needEntity: true,
        },
